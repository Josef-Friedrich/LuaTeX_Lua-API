...
it('unicode.xxx.gfind', function()
    assert.has_error(function() unicode.ascii.gfind('test') end,
                     "'string.gfind' was renamed to 'string.gmatch'")

    assert.has_error(function() unicode.latin1.gfind('test') end,
                     "'string.gfind' was renamed to 'string.gmatch'")

    assert.has_error(function() unicode.grapheme.gfind('test') end,
                     "'string.gfind' was renamed to 'string.gmatch'")

    assert.has_error(function() unicode.utf8.gfind('test') end,
                     "'string.gfind' was renamed to 'string.gmatch'")
