-- https://raw.githubusercontent.com/TeX-Live/luatex/f52b099f3e01d53dc03b315e1909245c3d5418d3/manual/old/fdata_epdf.lua
...
local fdata_epdf = {
    functions = {
        open = {
            ...
            arguments = {{type = "string", name = "filename", optional = false}},
            returnvalues = {{type = "PDFDoc", name = "var", optional = false}}
        },
        Annot = {
            type = "function",
            ...
            returnvalues = {{type = "Annot", name = "var", optional = false}}
        },
        Annots = {
            type = "function",
            ...
            returnvalues = {{type = "Annots", name = "var", optional = false}}
        },
        Array = {
            type = "function",
            shortdesc = "Construct an Array object.",
            arguments = {{type = "XRef", name = "xref", optional = false}},
            returnvalues = {{type = "Array", name = "var", optional = false}}
        },
        Dict = {
            type = "function",
            shortdesc = "Construct a Dict object.",
            arguments = {{type = "XRef", name = "xref", optional = false}},
            returnvalues = {{type = "Dict", name = "var", optional = false}}
        },
        Object = {
            type = "function",
            shortdesc = "Construct an Object object.",
            arguments = {},
            returnvalues = {{type = "Object", name = "var", optional = false}}
        },
        PDFRectangle = {
            type = "function",
    ...
    methods = {
        ...
        Annot = {
            isOK = {
                ...
                arguments = {{type = "Annot", name = "annot", optional = false}},
                returnvalues = {
        ...
        Array = {
            incRef = {
                ...
                arguments = {{type = "Array", name = "array", optional = false}},
                returnvalues = {}
            },
            decRef = {
                type = "function",
        ...
        Catalog = {
            ...
            getPage = {
                ...
                returnvalues = {{type = "Page", name = "var", optional = false}}
            },
            getPageRef = {
                type = "function",
                ...
                returnvalues = {{type = "Ref", name = "var", optional = false}}
            },
            getBaseURI = {
                type = "function",
        ...
        Dict = {
            incRef = {
                ...
                arguments = {{type = "Dict", name = "dict", optional = false}},
                returnvalues = {}
            },
            decRef = {
                type = "function",
        ...
        Link = {
            isOK = {
                ...
                arguments = {{type = "Link", name = "link", optional = false}},
                returnvalues = {
                    {type = "boolean", name = "var", optional = false}
                }
            },
        ...
        Links = {
            getNumLinks = {
                ...
                arguments = {{type = "Links", name = "links", optional = false}},
                returnvalues = {
                    {type = "integer", name = "var", optional = false}
                }
            },
            getLink = {
                ...
                returnvalues = {{type = "Link", name = "var", optional = false}}
            }
        },
        ------------------------------------------------------------------------
        Object = {
        ...
        Page = {
            isOK = {
                ...
                arguments = {{type = "Page", name = "page", optional = false}},
                returnvalues = {
                    {type = "boolean", name = "var", optional = false}
                }
            },
        ...
        PDFDoc = {
            ...
            getXRef = {
                ...
                returnvalues = {{type = "XRef", name = "var", optional = false}}
            },
            getCatalog = {
                type = "function",
                shortdesc = "TODO",
