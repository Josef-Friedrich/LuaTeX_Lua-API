...
used by \PDFTEX\ and *DVI*PS, so that legacy fonts are supported transparently. If
...
\DB value           \BC description                                               \NC \NR
\TB
\NC \type{type1}    \NC this is a \POSTSCRIPT\ *Type1* font                     \NC \NR
...
*Type1* fonts is by loading the font via \type {fontloader.open} and use the
