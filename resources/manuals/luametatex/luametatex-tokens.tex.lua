...
---        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="PMbxUe36JPXeAO2Vy+i1n9Vb5UcJbJQcyv5gKzj7SuCCsHKN9XbVeQhCpNHSjce3xVU6lRbJSxGL4ASmDuQL4w==" /> <div data-target="custom-scopes.customScopesModalDialogFlash"></div>
--- <input type="hidden" id="custom_scope_id" name="custom_scope_id" data-target="custom-scopes.customScopesIdField">
--- <div class="form-group"> <label for="custom_scope_name">Name</label> <auto-check src="/search/custom_scopes/check_name" required> <input type="text" name="custom_scope_name" id="custom_scope_name" data-target="custom-scopes.customScopesNameField" class="form-control" autocomplete="off" placeholder="github-ruby" required maxlength="50"> <input type="hidden" data-csrf="true" value="fW4T6D39alzyrF/hWPMEN03qvRUQcOwYetsiit2Bkyht+ssV3mpMqC7sUQ+jlfzwu6o+p/A3pWm4dGquFiOArg==" /> </auto-check> </div>
...
---</svg>
---        <span data-content="Security">Security</span> <include-fragment src="/contextgarden/context/security/overall-count" accept="text/fragment+html" data-nonce="v2:69d23972-0dea-0dfc-7021-6144575a6324" data-view-component="true">
---  
