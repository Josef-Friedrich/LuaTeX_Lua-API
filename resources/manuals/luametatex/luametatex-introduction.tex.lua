...
---        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="pgVc+dvvi2GI3YQUphkcksWWZEWtqj3ACRlHOSIFkkN9kAA1QPRFS85wMELp0dCY/riQcray01CGK8zV4oRyNw==" /> <div data-target="custom-scopes.customScopesModalDialogFlash"></div>
--- <input type="hidden" id="custom_scope_id" name="custom_scope_id" data-target="custom-scopes.customScopesIdField">
--- <div class="form-group"> <label for="custom_scope_name">Name</label> <auto-check src="/search/custom_scopes/check_name" required> <input type="text" name="custom_scope_name" id="custom_scope_name" data-target="custom-scopes.customScopesNameField" class="form-control" autocomplete="off" placeholder="github-ruby" required maxlength="50"> <input type="hidden" data-csrf="true" value="JiB8VGGYEJ5qd2dTYLgnx89Zl1aHonlEPHgEDa98lJ1qq89fmYHbIu+KC1O0hp+6WjdwbQWXoJPdO02BW2A3cg==" /> </auto-check> </div>
...
---</svg>
---        <span data-content="Security">Security</span> <include-fragment src="/contextgarden/context/security/overall-count" accept="text/fragment+html" data-nonce="v2:c5066166-efee-2d29-ea98-6953c110489c" data-view-component="true">
---  
