...
---        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="YelS30FVEMp00ElnSj1v8OzFKRbRAQDDDxFCE8jflOtfwLJH7JvZ6BB5WX6TTImpuXwaWggF1r2B/+/xYNQqSw==" /> <div data-target="custom-scopes.customScopesModalDialogFlash"></div>
--- <input type="hidden" id="custom_scope_id" name="custom_scope_id" data-target="custom-scopes.customScopesIdField">
--- <div class="form-group"> <label for="custom_scope_name">Name</label> <auto-check src="/search/custom_scopes/check_name" required> <input type="text" name="custom_scope_name" id="custom_scope_name" data-target="custom-scopes.customScopesNameField" class="form-control" autocomplete="off" placeholder="github-ruby" required maxlength="50"> <input type="hidden" data-csrf="true" value="O98ozxi0dg+TA769UBt73mFisYVuTIPlrLjOc4Vthyv98ogyzfMxaIarJf0XRILmJV8M8QUFdLyJF/flWX667g==" /> </auto-check> </div>
...
---</svg>
---        <span data-content="Security">Security</span> <include-fragment src="/contextgarden/context/security/overall-count" accept="text/fragment+html" data-nonce="v2:9a178316-6920-70d3-59e0-c9d6f417bb8f" data-view-component="true">
---  
